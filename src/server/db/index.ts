  ...
  return [
    {
      ...
      content: `# About
        ...
        HPE Brand Central is a cornerstone web application for HPE employees and clients.  We were brought onto
        this project to deliver a modern progressive web application that could be fully managed by the client.
      `,
    },
    {
      title: 'Grommet CMS',
      ...
      content: `# About
        As part of our work on the HPE Brand Central site, we sought out to build a
        content management system that was as modern and progressive as the site we built from it.
      `,
    },
    {
